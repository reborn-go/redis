module github.com/reborn-go/redis/example/otel

go 1.14

replace github.com/reborn-go/redis/v8 => ../..

replace github.com/reborn-go/redis/extra/redisotel/v8 => ../../extra/redisotel

replace github.com/reborn-go/redis/extra/rediscmd/v8 => ../../extra/rediscmd

require (
	github.com/reborn-go/redis/extra/redisotel/v8 v8.11.4
